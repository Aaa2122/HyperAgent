...
class PaperMarketData:
    ...
    def snapshot(self) -> FeatureSheet:
        ...
        return FeatureSheet(
            ...
            assets=[
                self._asset(
                    "BTC", prices["BTC"], ret_4h=2.4, adx=34.0,
                    donchian=0.91, ema_distance=1.25, funding=0.008,
                ),
                self._asset(
                    "ETH", prices["ETH"], ret_4h=0.15, adx=14.0,
                    donchian=0.52, ema_distance=0.08, funding=0.004,
                ),
                self._asset(
                    "SOL", prices["SOL"], ret_4h=-2.1, adx=31.0,
                    donchian=0.10, ema_distance=-1.8, funding=0.031,
                ),
            ],
